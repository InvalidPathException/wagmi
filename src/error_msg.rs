...
pub const FUNCTION_CODE_INCONSISTENT: &str = "function and code section have inconsistent lengths";
pub const ILLEGAL_OPCODE: &str = "illegal opcode";
pub const INTEGER_TOO_LARGE: &str = "integer too large";
pub const INTEGER_TOO_LONG: &str = "integer representation too long";
...
pub const CONSTANT_EXPRESSION_REQUIRED: &str = "constant expression required";
...
pub const INVALID_TABLE_ELEMENT_TYPE: &str = "invalid table element type";
...
pub const START_FUNCTION: &str = "start function";
...
pub const UNKNOWN_MEMORY_0: &str = "unknown memory 0";
...
pub const FUNCTION_NO_IMPLEMENTATION: &str = "function has no implementation";
...
pub const ELEMENTS_SEGMENT_DOES_NOT_FIT: &str = "elements segment does not fit";
