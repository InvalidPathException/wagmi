...
pub const TYPE_MISMATCH_PARAMS_VS_RESULTS: &str = "type mismatch params vs. results";
pub const TYPE_MISMATCH_STACK_VS_RESULTS: &str = "type mismatch stack vs. results";
